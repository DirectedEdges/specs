...
| # | Title | Highlights |
|---|-------|------------|
| 091 | Concern Documents Are a Typed Root Document | Adds `SpecConcernDocument` — a component's properties all optional — and `Metadata.concern`, so `splitConcerns` output validates |
