...
**Territory: schema.** Before proceeding, read `CLAUDE.md` and `ARCHITECTURE.md` at the repo root if not already loaded this session — the Constitution digest and sync set there govern every ADR.
