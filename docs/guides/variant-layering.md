...
Controls how many prop dimensions are expanded. See the [Variant Depth](variant-depth.md) guide.

---

## See Also

- [Variant Depth](variant-depth.md) — controlling variant expansion depth
