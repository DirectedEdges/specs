...
See the [applyCustomTokens command](../cli/commands/apply-custom-tokens.md) for details on the mapping format.

## Further Reading

- [ADR 007 — Token Reference Config](../../adr/007-token-reference-config.md) — architecture decision record consolidating the token format into a single enum
