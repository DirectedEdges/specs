...
The `Layout` type provides a recursive tree representation of element nesting. It's an alternative to `parent`/`children` on [`Element`](elements.md) for expressing hierarchy.
