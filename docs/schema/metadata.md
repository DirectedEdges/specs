...
| `config` | [`Config`](config.md) | Yes | The configuration used to generate this spec |

## Further Reading

- [ADR 001 — Surface License State in Component Output](../../adr/001-metadata.license.md) — adds `generator.license` for downstream entitlement gating
