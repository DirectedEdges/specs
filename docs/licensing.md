...
> **Note**: Token references require that your source config includes `variables` in the `data` array. Style references require `styles`. See [Configuration](./cli/configuration.md) for details.
...
- [Getting Started](./cli/getting-started.md) — Installation and first spec
- [Configuration Reference](./cli/configuration.md) — All config options
- [Config Schema](./schema/config.md) — Config type reference and defaults
