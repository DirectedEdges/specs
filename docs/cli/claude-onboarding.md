# Claude Code Onboarding — Specs CLI
...
> https://github.com/directededges/specs/blob/main/docs/cli/claude-onboarding.md
> ```
>
...
- See `docs/cli/examples.md` for CI/CD automation.
...
- [Getting Started](./getting-started.md) — the human-written walkthrough, for reference
- [Configuration Reference](./configuration.md) — full option docs (link here instead of restating when the user wants detail)
- [Commands Reference](./commands/) — per-command flags and behavior
