...
## Figma plugin for on-canvas specs

Generate and review specs on the canvas without leaving Figma — styled your way and tuned to your file's conventions.

<DemoCarousel set="plugin" />

## Commands for LLMs, agents, and pipelines

Spec an entire library from your terminal in minutes — then transform, analyze, and feed it to agents and CI.
