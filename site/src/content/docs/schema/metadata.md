...
| `concern` | `Concern` | No | Which slice of a component this document carries — `api`, `styling`, or `variants` — when a run wrote one file per concern. Absent on a single-file component; see [Component](/schema/component/) |
