...
|---|---|
| `glyph` | Glyph |
| `vectors` | Vector, Ellipse, Star, Polygon |
| `line` | Line |

Rectangles use [`backgroundColor`](/schema/styles/background-color/) instead. Text elements use [`textColor`](/schema/styles/text-color/) instead.
