...
Reads from `y` when the vertical constraint is `CENTER`. See [ADR 041 — Layout Positioning](https://github.com/DirectedEdges/specs/blob/main/adr/041-layout-positioning.md).
