...
Branch data includes unpublished changes — variables, styles, and components that haven't been merged or published to main. See [Fetching Figma Branches](/specs/cli/commands/fetch.md/#fetching-figma-branches) for implications.
...
- [Commands Reference](/specs/cli/commands/) - CLI command options
