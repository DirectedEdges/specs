...
| `packages/schema/schema/component.schema.json` | Primary JSON Schema — must mirror the `Component` tree; also defines `SpecConcernDocument`, the same properties with everything optional |
