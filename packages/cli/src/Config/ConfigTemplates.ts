...
export function generateConfigTemplate(): string {
  return `# Anova CLI Configuration (production-ready defaults)
#
...
# See: https://docs.anova.dev/cli/configuration#author
# author: Your Name
...
model:
  ...
  format:
    ...
    # See: https://docs.anova.dev/cli/configuration#tokens
  ...
  include:
    ...
    # See: https://docs.anova.dev/cli/configuration#variantNames
    variantNames: ${DEFAULT_MODEL_CONFIG.include?.variantNames !== false ? 'true' : 'false'}

    # Include invalid variant data in output
    # See: https://docs.anova.dev/cli/configuration#invalidVariants
    ...
    # See: https://docs.anova.dev/cli/configuration#invalidCombinations
